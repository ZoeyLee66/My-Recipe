...
const RecipeSchema = CollectionSchema(
  ...
  idName: r'id',
  indexes: {
    r'recipeName': IndexSchema(
      id: 5123569633963754556,
      name: r'recipeName',
      unique: false,
      replace: false,
      properties: [
...
void _recipeSerialize(
  ...
  writer.writeStringList(offsets[4], object.steps);
...
Recipe _recipeDeserialize(
  ...
  object.steps = reader.readStringList(offsets[4]) ?? [];
...
extension RecipeQueryWhereSort on QueryBuilder<Recipe, Recipe, QWhere> {
  ...
  QueryBuilder<Recipe, Recipe, QAfterWhere> anyCreatedAt() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Recipe, Recipe, QAfterWhere> anyUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension RecipeQueryWhere on QueryBuilder<Recipe, Recipe, QWhereClause> {
  ...
  QueryBuilder<Recipe, Recipe, QAfterWhereClause> createdAtEqualTo(
      DateTime createdAt) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<Recipe, Recipe, QAfterWhereClause> createdAtNotEqualTo(
      DateTime createdAt) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Recipe, Recipe, QAfterWhereClause> createdAtGreaterThan(
    DateTime createdAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Recipe, Recipe, QAfterWhereClause> createdAtLessThan(
    DateTime createdAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Recipe, Recipe, QAfterWhereClause> createdAtBetween(
  ...
  QueryBuilder<Recipe, Recipe, QAfterWhereClause> updatedAtEqualTo(
      DateTime updatedAt) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<Recipe, Recipe, QAfterWhereClause> updatedAtNotEqualTo(
      DateTime updatedAt) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Recipe, Recipe, QAfterWhereClause> updatedAtGreaterThan(
    DateTime updatedAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Recipe, Recipe, QAfterWhereClause> updatedAtLessThan(
    DateTime updatedAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Recipe, Recipe, QAfterWhereClause> updatedAtBetween(
...
extension RecipeQueryFilter on QueryBuilder<Recipe, Recipe, QFilterCondition> {
  ...
  QueryBuilder<Recipe, Recipe, QAfterFilterCondition> recipeNameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'recipeName',
        value: '',
  ...
  QueryBuilder<Recipe, Recipe, QAfterFilterCondition> recipeNameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'recipeName',
        value: '',
